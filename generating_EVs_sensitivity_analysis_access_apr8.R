...
weighted_RRs_every_week=mapply("defined_function",drug_coverage_prop=all_params$drug_coverage_prop,
                                                      delay_test_to_treatment=all_params$delay_test_to_treatment,
                                                      MoreArgs = list(j_max=4,data=LFT_curve_summary,index=7,incubation_period=3,
                                                                      drug_efficacy_period1=RR_period1,
                                                                      drug_efficacy_period2=RR_period2,
                                                                      drug_efficacy_period3=RR_period3,
                                                                      drug_efficacy_period4=RR_period4,
...
plot_ly(all_params_weighted_RRs_every_week,x=~delay,y=~drug_coverage,z=~weighted_RR,
        type='contour', contours=list(start=0,end=1,size=0.1))%>%
  layout(xaxis=list(title='delay test to treatment'),
         yaxis = list(title='drug coverage proportion'))%>%
  colorbar(title = "weighted RR")
...
weighted_RRs_every_two_weeks=mapply("defined_function",drug_coverage_prop=all_params$drug_coverage_prop,
                                                           delay_test_to_treatment=all_params$delay_test_to_treatment,
                                                           MoreArgs = list(j_max=2,data=LFT_curve_summary,index=14,incubation_period=3,
                                                                           drug_efficacy_period1=RR_period1,
                                                                           drug_efficacy_period2=RR_period2,
                                                                           drug_efficacy_period3=RR_period3,
                                                                           drug_efficacy_period4=RR_period4,
...
plot_ly(all_params_weighted_RRs_every_two_weeks,x=~delay,y=~drug_coverage,z=~weighted_RR,
        type='contour', contours=list(start=0,end=1,size=0.1))%>%
  layout(xaxis=list(title='delay test to treatment'),
         yaxis = list(title='drug coverage proportion'))%>%
  colorbar(title = "weighted RR")

## rerun w/ omicron-specific incubation

weighted_RRs_every_other_day_incubation_sensitivity=mapply("defined_function",drug_coverage_prop=all_params$drug_coverage_prop,
                                    delay_test_to_treatment=all_params$delay_test_to_treatment,
                                    MoreArgs = list(j_max=15,data=LFT_curve_summary,index=2,incubation_period=3,
                                                    drug_efficacy_period1=RR_period1,
                                                    drug_efficacy_period2=RR_period2,
                                                    drug_efficacy_period3=RR_period3,
                                                    drug_efficacy_period4=RR_period4,
                                                    ...
                                                    drug_efficacy_period8=RR_period8,
                                                    drug_efficacy_period9=RR_period9))
all_params_weighted_RRs_every_other_day_incubation_sensitivity=cbind.data.frame(all_params,weighted_RR=weighted_RRs_every_other_day_incubation_sensitivity)
colnames(all_params_weighted_RRs_every_other_day_incubation_sensitivity)<-c('drug_coverage','delay','weighted_RR')


plot_ly(all_params_weighted_RRs_every_other_day_incubation_sensitivity,x=~delay,y=~drug_coverage,z=~weighted_RR,
        type='contour',contours=list(start=0,end=1,size=0.1))%>%
  layout(xaxis=list(title='delay test to treatment'),
         yaxis = list(title='drug coverage proportion'))%>%
  colorbar(title = "weighted RR")
...
# colnames(all_params_weighted_RRs_every_other_day_incubation_sensitivity)<-c('drug coverage','delay','weighted RR')
# plot_ly(all_params_weighted_RRs_every_other_day_incubation_sensitivity,x=~delay,y=~`drug coverage`,z=~`weighted RR`,
#         type='scatter3d',mode='markers',marker = list(color = ~'#E69F00'))
# 


weighted_RRs_every_three_days_incubation_sensitivity=mapply("defined_function",
                                                            drug_coverage_prop=all_params$drug_coverage_prop,
                                     delay_test_to_treatment=all_params$delay_test_to_treatment,
                                     MoreArgs = list(j_max=10,data=LFT_curve_summary,index=3,incubation_period=3,
                                                     drug_efficacy_period1=RR_period1,
                                                     drug_efficacy_period2=RR_period2,
                                                     drug_efficacy_period3=RR_period3,
                                                     drug_efficacy_period4=RR_period4,
                                                     ...
                                                     drug_efficacy_period8=RR_period8,
                                                     drug_efficacy_period9=RR_period9))
all_params_weighted_RRs_every_three_days_incubation_sensitivity=cbind.data.frame(all_params,weighted_RR=weighted_RRs_every_three_days_incubation_sensitivity)
colnames(all_params_weighted_RRs_every_three_days_incubation_sensitivity)<-c('drug_coverage','delay','weighted_RR')

plot_ly(all_params_weighted_RRs_every_three_days_incubation_sensitivity,x=~delay,y=~drug_coverage,z=~weighted_RR,
        type='contour', contours=list(start=0,end=1,size=0.1))%>%
  layout(xaxis=list(title='delay test to treatment'),
         yaxis = list(title='drug coverage proportion'))%>%
  colorbar(title = "weighted RR")

# colnames(all_params_weighted_RRs_every_three_days_incubation_sensitivity)<-c('drug coverage','delay','weighted RR')
# plot_ly(all_params_weighted_RRs_every_three_days_incubation_sensitivity,x=~delay,y=~`drug coverage`,z=~`weighted RR`,
#         type='scatter3d',mode='markers',marker = list(color = ~'#CC79A7'))


weighted_RRs_every_week_incubation_sensitivity=mapply("defined_function",
                                                      drug_coverage_prop=all_params$drug_coverage_prop,
                               delay_test_to_treatment=all_params$delay_test_to_treatment,
                               MoreArgs = list(j_max=4,data=LFT_curve_summary,index=7,incubation_period=3,
                                               drug_efficacy_period1=RR_period1,
                                               ...
                                               drug_efficacy_period8=RR_period8,
                                               drug_efficacy_period9=RR_period9))
all_params_weighted_RRs_every_week_incubation_sensitivity=cbind.data.frame(all_params,
                                                    weighted_RR=weighted_RRs_every_week_incubation_sensitivity)
colnames(all_params_weighted_RRs_every_week_incubation_sensitivity)<-c('drug_coverage','delay','weighted_RR')

plot_ly(all_params_weighted_RRs_every_week_incubation_sensitivity,x=~delay,y=~drug_coverage,z=~weighted_RR,
        type='contour', contours=list(start=0,end=1,size=0.1))%>%
  layout(xaxis=list(title='delay test to treatment'),
         yaxis = list(title='drug coverage proportion'))%>%
  colorbar(title = "weighted RR")

# colnames(all_params_weighted_RRs_every_week_incubation_sensitivity)<-c('drug coverage','delay','weighted RR')
# plot_ly(all_params_weighted_RRs_every_week_incubation_sensitivity,x=~delay,y=~`drug coverage`,z=~`weighted RR`,
#         type='scatter3d',mode='markers',marker = list(color = ~'#009E73'))
# 


weighted_RRs_every_two_weeks_incubation_sensitivity=mapply("defined_function",drug_coverage_prop=all_params$drug_coverage_prop,
                                    delay_test_to_treatment=all_params$delay_test_to_treatment,
                                    MoreArgs = list(j_max=2,data=LFT_curve_summary,index=14,incubation_period=3,
                                                    drug_efficacy_period1=RR_period1,
                                                    drug_efficacy_period2=RR_period2,
                                                    ...
                                                    drug_efficacy_period8=RR_period8,
                                                    drug_efficacy_period9=RR_period9))
all_params_weighted_RRs_every_two_weeks_incubation_sensitivity=cbind.data.frame(all_params,weighted_RR=weighted_RRs_every_two_weeks_incubation_sensitivity)
colnames(all_params_weighted_RRs_every_two_weeks_incubation_sensitivity)<-c('drug_coverage','delay','weighted_RR')
